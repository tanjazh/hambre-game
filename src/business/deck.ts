...
export class RealDeckFactory implements DeckFactory {
    ...
    public createDeck(): Deck {
        const cards: Card[] = [
            ...
            new Card(Points.One, [Color.Orange], ""),
            new Card(Points.One, [Color.Orange], ""),
            new Card(Points.Two, [Color.Orange], ""),
            new Card(Points.Two, [Color.Orange], ""),
            new Card(Points.Two, [Color.Orange], ""),
            new Card(Points.Two, [Color.Orange], ""),
            new Card(Points.Three, [Color.Orange], ""),
            new Card(Points.Three, [Color.Orange], ""),
            new Card(Points.One, [Color.Blue], ""),
            new Card(Points.One, [Color.Blue], ""),
            new Card(Points.One, [Color.Blue], ""),
            new Card(Points.One, [Color.Blue], ""),
            new Card(Points.One, [Color.Blue], ""),
            ...
            new Card(Points.One, [Color.Blue], ""),
            new Card(Points.One, [Color.Blue], ""),
            new Card(Points.Two, [Color.Blue], ""),
            new Card(Points.Two, [Color.Blue], ""),
            new Card(Points.Two, [Color.Blue], ""),
            new Card(Points.Two, [Color.Blue], ""),
            new Card(Points.Three, [Color.Blue], ""),
            new Card(Points.Three, [Color.Blue], ""),
            new Card(Points.Three, [Color.Blue], ""),
            new Card(Points.Three, [Color.Blue], ""),
            ...
            new Card(Points.One, [Color.Green], ""),
            new Card(Points.One, [Color.Green], ""),
            new Card(Points.Two, [Color.Green], ""),
            new Card(Points.Two, [Color.Green], ""),
            new Card(Points.Three, [Color.Green], ""),
            new Card(Points.Three, [Color.Green], ""),
            ...
            new Card(Points.One, [Color.Purple], ""),
            new Card(Points.One, [Color.Purple], ""),
            new Card(Points.Two, [Color.Purple], ""),
            new Card(Points.Two, [Color.Purple], ""),
            new Card(Points.Two, [Color.Purple], ""),
            new Card(Points.Two, [Color.Purple], ""),
            new Card(Points.One, [Color.Blue, Color.Orange], ""),
            new Card(Points.One, [Color.Blue, Color.Orange], ""),
            new Card(Points.One, [Color.Blue, Color.Orange], ""),
            new Card(Points.One, [Color.Blue, Color.Orange], ""),
            new Card(Points.One, [Color.Green, Color.Orange], ""),
            new Card(Points.One, [Color.Green, Color.Orange], ""),
            new Card(Points.One, [Color.Green, Color.Orange], ""),
            new Card(Points.One, [Color.Green, Color.Orange], ""),
            new Card(Points.Three, [Color.Green, Color.Purple], ""),
            new Card(Points.Three, [Color.Green, Color.Purple], ""),
            new Card(Points.Three, [Color.Green, Color.Purple], ""),
            new Card(Points.Three, [Color.Green, Color.Purple], ""),
            new Card(Points.One, [Color.Orange, Color.Green, Color.Purple], ""),
            new Card(Points.One, [Color.Orange, Color.Green, Color.Purple], ""),
            new Card(Points.Three, [Color.Blue, Color.Orange, Color.Green, Color.Purple], ""),
            new Card(Points.Three, [Color.Blue, Color.Orange, Color.Green, Color.Purple], "")
        ];
        cards.sort(() => Math.random() - 0.5); //shuffling cards
        return new Deck(cards)
